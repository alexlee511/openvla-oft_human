...
import sys
from LIBERO_Object_humanized.conversion_utils import MultiThreadedDatasetBuilder
...
class LiberoObjectHumanized(MultiThreadedDatasetBuilder):
    """DatasetBuilder for humanized LIBERO-Object dataset (absolute joint pos)."""
    ...
    def _split_paths(self):
        ...
        # ====================================================================
        return {
            "train": glob.glob("/home/vsp1323/openvla-oft/LIBERO/libero/datasets/LIBERO_Object_humanized/*.hdf5"),
        }

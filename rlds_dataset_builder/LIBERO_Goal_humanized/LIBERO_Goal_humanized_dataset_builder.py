...
import sys
from LIBERO_Goal_humanized.conversion_utils import MultiThreadedDatasetBuilder
...
class LiberoGoalHumanized(MultiThreadedDatasetBuilder):
    """DatasetBuilder for humanized LIBERO-Goal dataset (absolute joint pos)."""
    ...
    def _split_paths(self):
        ...
        # ====================================================================
        return {
            "train": glob.glob("/home/vsp1323/openvla-oft/LIBERO/libero/datasets/LIBERO_Goal_humanized/*.hdf5"),
        }

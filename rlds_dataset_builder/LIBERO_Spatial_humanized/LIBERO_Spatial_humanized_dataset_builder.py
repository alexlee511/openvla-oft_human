...
import sys
from LIBERO_Spatial_humanized.conversion_utils import MultiThreadedDatasetBuilder
    ...
    for sample in paths:
        ...
        while cnt < n_demos:
            ...
            if ret is not None:
                ...
                yield ret
            idx += 1
            # safety limit to avoid infinite loop if demo indices are sparse
            if idx > n_demos * 3:
                break


class LiberoSpatialHumanized(MultiThreadedDatasetBuilder):
    """DatasetBuilder for humanized LIBERO-Spatial dataset (absolute joint pos)."""
            ...
            features=tfds.features.FeaturesDict({
                'steps': tfds.features.Dataset({
                    ...
                    'action': tfds.features.Tensor(
                        shape=(8,),
                        dtype=np.float32,
                        doc='Absolute joint position targets (7) + gripper (1).',
                    ),
    ...
    def _split_paths(self):
        ...
        # ====================================================================
        # IMPORTANT: Update this path to point to your npz_to_hdf5.py output!
        # ====================================================================
        return {
            "train": glob.glob("/home/vsp1323/openvla-oft/LIBERO/libero/datasets/LIBERO_Spatial_humanized/*.hdf5"),
        }

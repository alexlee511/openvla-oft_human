...
class LiberoObjectJoint(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        return {
            "train": glob.glob(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "LIBERO", "libero", "datasets", "libero_object_joint_no_noops", "*.hdf5")),
        }
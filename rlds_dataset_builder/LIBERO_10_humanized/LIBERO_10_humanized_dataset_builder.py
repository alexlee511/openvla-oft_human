...
import sys
from LIBERO_10_humanized.conversion_utils import MultiThreadedDatasetBuilder
...
class Libero10Humanized(MultiThreadedDatasetBuilder):
    """DatasetBuilder for humanized LIBERO-10 dataset (absolute joint pos)."""
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "LIBERO", "libero", "datasets", "libero_10_humanized_no_noops", "*.hdf5")),
        }

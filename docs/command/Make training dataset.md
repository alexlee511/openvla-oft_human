...
# suffix produced under LIBERO_human/scripts/result/humanized_npz/
...
python experiments/robot/libero/A_npz_to_hdf5.py \
  --task_roots_dir LIBERO_human/scripts/result/humanized_npz/libero_10_humanized_th-ik \

...
Usage (single task):
    python experiments/robot/libero/A_npz_to_hdf5.py \\
        --task_root ../LIBERO-humanized/scripts/result/humanized_npz/libero_10_humanized/KITCHEN_SCENE3_turn_on_the_stove_and_put_the_moka_pot_on_it_demo \\
        --output_dir ./LIBERO/libero/datasets/libero_10_humanized_noops \\
        --filter_noops --require_success

Usage (all tasks in a directory):
    python experiments/robot/libero/A_npz_to_hdf5.py \\
        --task_roots_dir ../LIBERO-humanized/scripts/result/humanized_npz/libero_10_humanized \\
        --output_dir ./LIBERO/libero/datasets/libero_10_humanized_noops \\
        --filter_noops --require_success
"""
...
def discover_demos_from_task_root(task_root, require_success=False):
    ...
    Given a task root like:
        ../LIBERO-humanized/scripts/result/humanized_npz/<suite>/KITCHEN_SCENE3_..._demo/
...
if __name__ == "__main__":
    ...
    source.add_argument(
        ...
        help="Directory of task root folders, e.g. ../LIBERO-humanized/scripts/result/humanized_npz/<suite>",
    )
